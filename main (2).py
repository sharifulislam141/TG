...
os.system('figlet -f big DORKER')
print'''\u001b[35m  AUTHOR : TEAM BADS
...
def dorkmaker(word):
    ...
    #
try:
    print(' Donate(BTC): 17nRr6QzzCAXrkZxsytnMqvgN3aEGixJef\n')
except:
    pass
print("\u001b[0mENTER SOME TEXT\n")
text = input ("Enter Kayword : ")
words = text.split(" ")
for word in words:
    dorkmaker(word)
